 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/diogo/Documents/CCS/workspace_v88_100hz/project_zero_app_cc2650stk/Debug/configPkg/package/cfg/app_ble_uartlog_pem3");
 ...
 */
xdc_Bool xdc_runtime_LoggerCallback_Module__startupDone__F(void); /* keep GCC prototype warning quiet */
...
__FAR__ const xdc_runtime_Core_ObjDesc xdc_runtime_LoggerCallback_Object__DESC__C = {
    (xdc_CPtr)&xdc_runtime_LoggerCallback_Module__FXNS__C, /* fxnTab */
    ...
    (xdc_CPtr)&xdc_runtime_LoggerCallback_Object__PARAMS__C, /* prmsInit */
...
{
    xdc_runtime_Core_assignParams__I(prms, (xdc_CPtr)(src ? src : &xdc_runtime_LoggerCallback_Object__PARAMS__C), psz, isz);
}
